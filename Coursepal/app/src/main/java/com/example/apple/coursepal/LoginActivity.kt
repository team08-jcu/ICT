...
class LoginActivity : AppCompatActivity() {
   ...
   // private var google_login: Button? = null
    ...
    private fun initialise() {
     ...
     //   google_login!!.setOnClickListener{ startActivity(Intent(this@LoginActivity,
...
Log.d(TAG,"Log -1")
    ...
    private fun updateUI() {
        val intent = Intent(this@LoginActivity, ListMain2Activity::class.java)
